...
async function fetchProgressSummary() {
  const list = await api_http.request({ url: "/progress", method: "GET" });
...
exports.emptyProgress = emptyProgress;
exports.fetchProgressSummary = fetchProgressSummary;
//# sourceMappingURL=../../.sourcemap/mp-weixin/api/progress.js.map
